...
Welcome to my project **Psychosis in MRI**.
My name is Julie Folkerts.
Date of completion: 18-12-2025.
...
Tale of contents:
1. **Data used**
   - Anatomical MRI file ('anatomical.nii')
   - Functional connectivity file ('functional_connectivitiy_0_0_0.nii')
2. **Notebook**
